  ...
  return (
    <div id="pricing" className="py-16">
      <div className="container mx-auto px-1">
        ...
        <div className="max-w-4xl mx-auto flex flex-col-reverse md:flex-row gap-8">
          {/* Benefits Stack */}
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 md:grid-cols-1 place-content-evenly gap-6 sm:gap-4">
            <div className="flex items-start space-x-4">
              ...
              <div className="text-left max-w-sm">
                ...
                <p className="text-zinc-600 text-sm">
                  Get comprehensive feedback on your manuscript with our
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="text-left max-w-sm">
                ...
                <p className="text-zinc-600 text-sm">
                  Review as many manuscripts as you need with no monthly limits
                  or restrictions.
                </p>
              </div>
            </div>
